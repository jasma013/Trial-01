...
class Node:
    def __init__(self, data):
        ...
        self.data = data
        # Initialize the next attribute of the node as None, indicating that it initially does not point to any other node.
        self.next = None
...
class SinglyLinkedList:
    ...
    # Define a method named append to add a new node with the given data to the end of the linked list.
    def append(self, data):
        ...
        # Once the last node is found, set the next attribute of the last node to the new node, effectively adding it to the end of the linked list.
        last_node.next = new_node

    # Define a method named display to print the elements of the linked list.
    def display(self):
